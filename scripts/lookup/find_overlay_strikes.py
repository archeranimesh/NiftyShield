...
Usage:
    ...
    python -m scripts.lookup.find_overlay_strikes --overlay-type pp \
        --nifty-spot 24000 \
        --monthly 2026-05-29 --quarterly 2026-06-26 --yearly 2026-12-25

    # Covered Call
    python -m scripts.lookup.find_overlay_strikes --overlay-type cc \
        --nifty-spot 24000 \
        --monthly 2026-05-29 --quarterly 2026-06-26

    # Collar (both legs — uses max(put_spread, call_spread) for gate)
    python -m scripts.lookup.find_overlay_strikes --overlay-type collar \
        --nifty-spot 24000 \
        --monthly 2026-05-29 --quarterly 2026-06-26 --yearly 2026-12-25
...
def write_overlay_yaml(
    ...
    with open(path, "w") as f:
        f.write(
            "# Auto-generated by scripts/lookup/find_overlay_strikes.py\n"

...
|---|---|
| `AGENTS.md` | Auto-loaded project instructions — must be at root |
...
- Task-specific agent files in `.Codex/agents/` whose task is done → `docs/archive/`
...
mv .Codex/agents/<task-specific>.md docs/archive/
```

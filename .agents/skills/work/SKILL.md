...
6. State: the chosen story, the first unchecked task id + text, and any load hints the story's `prompt.md` calls for (module `CLAUDE.md`, `DECISIONS.md`, `REFERENCES.md`, `BACKTEST_PLAN.md`,
   `LITERATURE.md` entries).
7. Hand off to `CLAUDE.md` Step 2b — council checkpoint, then Step 3 plan + go-ahead, then the normal protocol. AutoTrigger agents fire per the `CLAUDE.md` table as implementation proceeds.

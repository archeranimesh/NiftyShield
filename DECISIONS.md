...
| 2026-05-27 | chain-data story supersedes tasks 1.10 + 1.10a: both tasks migrated to `docs/plan/chain-data/` story with Parquet storage confirmed. `1_10_dhan_chain_client.md` archived as ABANDONED. | — |

...
## Archived — pre-2026-07 reference sections

Five fully-historical, self-contained sections (no still-enforced rule content) moved to
[docs/archive/DECISIONS_pre-2026-07.md](docs/archive/DECISIONS_pre-2026-07.md) on 2026-08-27
(round-2 token-optimization #3b). One line each:

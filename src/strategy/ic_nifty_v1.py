...
class IronCondorV1:
    ...
    async def _send_close_notification(
        ...
        try:
            ...
            log.warning("ic_nifty_v1.instrument_lookup_failed", error=str(exc))
            lookup = None
        ...
        if self._store is None:
            ...
            # "footer_calc_failed" for a case that isn't a calc failure.
            log.warning("ic_nifty_v1.footer_calc_skipped_no_store")
        else:
            try:
                ...
                log.warning("ic_nifty_v1.footer_calc_failed", error=str(exc))
        ...
        try:
            ...
            log.warning("ic_nifty_v1.format_exit_message_failed", error=str(exc))
            return
        try:

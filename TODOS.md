...
4. [x] **Execution risk hardening** (2026-07-27, closed 2026-08-06) — `docs/plan/execution-risk-hardening/tasks.md`. All tasks landed: RH-1 (IC entry compensating close, SHA 880e3b0), RH-2 (paper_ prefix already enforced structurally, verification-only), RH-3 (council_rank still load-bearing, verification-only), RH-4 (shared warn-only NiftyBees collateral gate, SHA c0d7dd8), RH-5 (this docs-close entry). See `DECISIONS.md` 2026-08-06 entries for RH-1/RH-4.

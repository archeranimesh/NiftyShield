...
| 2026-06-27 | ic-nifty-v2 IC-V2-2 — IronCondorV2 adjustment: _evaluate_adjustment (DELTA_WARN/ROLL_WING/DELTA_STOP/FORCED_CLOSE), _execute_partial_roll (4-leg atomic), 7 roll guards, RollResult dataclass, state helpers reset_roll_state/set_original_credit; 11 tests |

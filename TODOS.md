...
| 10 | council-refactor: remove RapidCouncil from daemon path; fix approval bug; add deterministic roll rules | Cowork | Before 2026-06-23 roll week | — | 🔄 CR0 shipped 4ce6d99 — CR1 (evaluate_roll_csp) + CR2 (evaluate_roll_overlay) pending — [story](docs/plan/council-refactor/) |

...
| `suggestions-sweep/` | Cluster all ~40 `suggestions.md` rows; fix / enforce / accept each; make Step 4b self-draining | ✅ Done | `measurement/` | SWEEP-1..7 done — closing SHA `2d896a9` |

...
- [x] **DT-3b** `[Antigravity]` — Counterfactual DTE logging: `paper_exit_events.counterfactual_dte_marks` column + wiring at the call site DT-3a confirms + tests. Do not start until DT-3a's findings are written into `stories.md` — the spec as written is provisional. | SHAs: 17b4ff9 (schema), 92227f7 (V1), 524e86a (V2)
- [x] **DT-4** `[Claude]` — Docs close: `CONTEXT.md`, `TODOS.md`, `docs/plan/README.md` status row, schedule the 6-monthly-cycle review reminder | SHA: 49a3edf

...
**plan-folders/ complete — DFM-4 closed as no-op, no tier-C folders exist.**
...
- [x] **DFM-4** — reflow-only pass on every tier-C folder (structure already canonical) | Owner: Claude | Model: claude-sonnet-5 | Review: none | SHA: <pending>

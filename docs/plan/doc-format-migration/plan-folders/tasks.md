...
**Open: DFM-2, DFM-3, DFM-4.**

- [x] **DFM-1** — enumerate + tier every non-archived `docs/plan/` folder (A/B/C/D), record the table in `stories.md` | Owner: Claude | Model: claude-sonnet-5 | Review: none | SHA: PENDING

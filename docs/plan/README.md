...
**`signals/`** · 🔨 In progress · next: **S5.2a** (source-discovery spike + `src/signals/market_inputs.py`; S5.2 split into S5.2a/S5.2b/S5.2 on 2026-09-07) — S4.1 `417cb5f`, S5.1 `80edf53`

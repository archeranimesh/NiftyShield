...
**`root-doc-organization/`** · 🔄 In progress · next: **RDO-17.4** (`docs/plan/` story/epic
format standardization — RDO-17.1/17.2/17.3 shipped; RDO-16 loop-closure and RDO-11 ≥ 2026-09-03 also open)

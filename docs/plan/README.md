...
**`token-efficiency/`** · 🔄 In progress — `measurement/` done, `fixed-overhead/` FIX-1+FIX-2 done · next: **FIX-3**
...
**`telegram-markdown-migration/`** · 🔄 In progress — `strategy-rollout/` next: **ROLL-8** (ROLL-7 shipped `cad8074`)

...
| `overlay-entry-message/` | Sign-aware net line; Collar / CC / PP re-entry cards; three-track bootstrap onto the renderer (OEM-1..5) | 🔄 In progress | `unified-entry-message` | — |

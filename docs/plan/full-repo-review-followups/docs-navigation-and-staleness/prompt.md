...
declares a taxonomy (`docs/council/archive/{strategy,risk,research}/`, 3 subfolders) that hasn't existed since commit `da93b64` moved the tree to
`docs/archive/council/{strategy,risk,research,data_architecture,misc}/` (5 subfolders, different prefix) — this breaks two confirmed dead links: `docs/plan/variance-gate/prompt.md:18` and, more
seriously, `DECISIONS.md` lines 397-407 which cite the dead `docs/council/2026-05-28_paper-trade-exit-philosophy.md` as the source of record for live CSP/CC/PP/collar exit thresholds (content was also
...
**Surface & Model: Antigravity (handoff via `handoff-antigravity`); Claude Code / Sonnet for the review half.** Mechanical, grep-verifiable link/table fixes across 4 docs — within

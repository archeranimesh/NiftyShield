...
self-describing and the load-bearing fix is a REVIEW.md policy carve-out, not 100+ mechanical comment additions — triage, not blanket-fix.

**Surface & Model: Claude Code, Sonnet.** This is a policy-wording proposal (which REVIEW.md suppression codes are self-describing enough to carve out) — interpretive, not mechanical; Antigravity has
no mechanism for the judgment call of deciding a carve-out boundary, only for executing one already decided.

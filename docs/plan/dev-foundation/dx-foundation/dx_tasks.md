...
- [x] **DX-5** — Create `Makefile` (test, coverage, lint, fmt, security, ci, dead-code, index targets) — **Antigravity** | SHA: 5d391ac
- [ ] **DX-6** — Add `.git/hooks/post-commit` script for graph re-index + `scripts/dev/install_hooks.sh` — **Antigravity**

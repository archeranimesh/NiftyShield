...
| `suggestions-sweep/` | Cluster all ~40 `suggestions.md` rows; fix / enforce / accept each; make Step 4b self-draining | 🔄 In progress | `measurement/` | SWEEP-1..6 done; SWEEP-7 open |

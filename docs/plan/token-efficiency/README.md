...
| `fixed-overhead/` | Skill-ify `CLAUDE.md`, trim module `CLAUDE.md` files, redesign `session-close` off the fork, strip MCP result bloat | 🔄 FIX-1 done, FIX-2 next | `measurement/` | — |

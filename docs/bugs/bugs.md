...
| Status | 🟡 Phase 1 (correctness fix) ✅ Fixed 2026-08-10 — see `CONTEXT.md`'s BUG-028 Phase 1 entry and `docs/bugs/task.md` B028.1–B028.7 for the implementation. Phases 2 (eliminate silent false zeros) and 3 (historical repair script) not yet implemented — council mandate in `docs/council/2026-08-10_overlay-pnl-reporting-track-independence.md` (unanimous 4/4, Position B "B-lite") and `DECISIONS.md` 2026-08-10. |

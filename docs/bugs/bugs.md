...
| Status | 🟡 Phase 1 ✅ Fixed 2026-08-10, SHA `6820f81`. Phase 2 (eliminate silent false zeros) ✅ Fixed 2026-08-10, SHA `4b8b351` — see `CONTEXT.md`'s BUG-028 Phase 2 entry and `docs/bugs/task.md` B028.8–B028.10. Phase 3 (historical repair script, `scripts/dev/migrate_overlay_pnl_attribution.py`) implemented 2026-08-10 — `general-purpose`+`REVIEW.md` review clean (no CRITICAL/ERROR), but **tests not executed this session** (sandbox has no free disk for `pytest`/deps, same limitation class as prior BUG-020/021/026/027 sessions) — SHA pending a live-host test run + commit. See `docs/bugs/task.md` B028.11–B028.13. |
...
| Status | 🔴 Open — discovered 2026-08-10 while investigating BUG-028 Phase 3; fix (run the existing migration + add test coverage) not yet committed this session, see `docs/bugs/task.md` B029.1+. |

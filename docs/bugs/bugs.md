...
| Status | 🟡 Council-ruled, not yet implemented — design fork resolved 2026-08-10 via `docs/council/2026-08-10_overlay-pnl-reporting-track-independence.md` (unanimous 4/4, Position B "B-lite"); see `DECISIONS.md` 2026-08-10 BUG-028 entry for the full implementation mandate. Code not yet written — see `docs/bugs/task.md` for the 3-phase checklist. |

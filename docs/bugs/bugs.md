...
| Status | ✅ Fixed — all 3 phases complete 2026-08-10. Phase 1 SHA `6820f81`. Phase 2 (eliminate silent false zeros) SHA `4b8b351`. Phase 3 (historical repair script, `scripts/dev/migrate_overlay_pnl_attribution.py`) SHA `0fd4de8` — `general-purpose`+`REVIEW.md` review clean (no CRITICAL/ERROR), 5 tests confirmed green on live host. See `docs/bugs/task.md` B028.11–B028.13. |

...
| Status | 🟡 Partially fixed (SHA `ef1c341`, 2026-08-24) — B033.1-B033.3 done (code fix + tests + review); B033.4 (manual `NSE_FO|61604` roll/close decision) and B033.5 (close-out, blocked on BUG-034 landing) still open. Found 2026-08-24, during BUG-031's B031.4 manual exit-eligibility review. |
